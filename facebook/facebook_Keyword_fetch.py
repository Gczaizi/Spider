...
def geturl(Keywords):
    url = []
    for i in Keywords:
        tmp = "http://54.248.44.79:8888/post/facebook?kw=%s&num=50" % i
        url.append(tmp)
    return url
